...
import { detailContent } from "@/lib/content-detail"

// shadcn/ui breadcrumb (có sẵn trong stack của mày)
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function BoiCanhRaDoiPage() {
  ...
  const data = detailContent[language]
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <article className="max-w-3xl mx-auto space-y-10 animate-fade-in-up">
          ...
          {/* Khối ảnh: lấy từ detailContent.images; nếu chưa có src → placeholder */}
