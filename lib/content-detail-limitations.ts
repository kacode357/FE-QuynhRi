        ...
        source: [
          {
            ...
            url: "https://baotanglichsu.vn/vi/Articles/3096/71317/djoi-net-ve-bo-suu-tap-tem-phieu-thoi-ky-bao-cap-tai-bao-tang-lich-su-quoc-gia.html",
          },
        ],
      },
      {
...
Hình ảnh cuộc thu đổi tiền do TTXVN ghi lại là một tư liệu quan trọng.`,
        source: [
          {
            text: "THƯ VIỆN PHÁP LUẬT",
            url: "https://thuvienphapluat.vn/van-ban/Tien-te-Ngan-hang/Quyet-dinh-01-HDBT-TD-tien-ngan-hang-moi-thu-doi-tien-ngan-hang-cu-43628.aspx?utm_source=chatgpt.com",
          },
          {
            text: "TTXVN",
            url: "https://daihoidang.vn/tags/x%C3%B3a-b%E1%BB%8F-c%C6%A1-ch%E1%BA%BF-t%E1%BA%ADp-trung-quan-li%C3%AAu-bao-c%E1%BA%A5p.vnp",
          },
        ],
      },
      {
...
lạm phát bùng nổ lên ba con số, đỉnh 774,5% năm 1986, đến 1990 mới kéo về hai con số.`,
        source: [
          {
            ...
            url: "https://tapchicongthuong.vn/cuoc-tong-dieu-chinh-gia-luong-tien-nam-1985-111705.htm",
          },
          {
            text: "THƯ VIỆN PHÁP LUẬT",
            url: "https://thuvienphapluat.vn/van-ban/Tien-te-Ngan-hang/Quyet-dinh-01-HDBT-TD-tien-ngan-hang-moi-thu-doi-tien-ngan-hang-cu-43628.aspx?utm_source=chatgpt.com",
    ...
    images: [
      { alt: "Cuộc thu đổi tiền ngày 14/9/1985", src: "/hanchecoche1.png" },
      { alt: "Xếp hàng mua lương thực, thực phẩm thời kỳ bao cấp ở Hà Nội", src: "/hanchecoche2.png" },
    ],
  },
  en: {
...
Photos by VNA document the event.`,
        source: [
          {
            text: "LAW LIBRARY of Vietnam",
            url: "https://thuvienphapluat.vn/van-ban/Tien-te-Ngan-hang/Quyet-dinh-01-HDBT-TD-tien-ngan-hang-moi-thu-doi-tien-ngan-hang-cu-43628.aspx?utm_source=chatgpt.com",
          },
          {
            text: "Vietnam News Agency (VNA)",
            url: "https://daihoidang.vn/tags/x%C3%B3a-b%E1%BB%8F-c%C6%A1-ch%E1%BA%BF-t%E1%BA%ADp-trung-quan-li%C3%AAu-bao-c%E1%BA%A5p.vnp",
          },
        ],
      },
...
inflation surged to triple digits, peaking at 774.5% in 1986, only returning to double digits by 1990.`,
    ...
    images: [
      { alt: "1985 currency exchange", src: "/hanchecoche1.png" },
      { alt: "Queues for food in Hanoi during the subsidy era", src: "/hanchecoche2.png" },
    ],
  },
};