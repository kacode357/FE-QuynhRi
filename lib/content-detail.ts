export const detailContent = {
  vi: {
    ...
    subtitle: "Hoàn cảnh lịch sử và lý do tồn tại của cơ chế bao cấp",
    sections: [
      {
        heading: "Hoàn cảnh chung",
...
Bảo tàng Lịch sử Quốc gia mô tả rõ cơ chế và phạm vi áp dụng, cho thấy tính chất bắt buộc của phân phối hiện vật trong điều kiện thiếu thốn.`,
      ...
      },
      {
        ...
        text: `Trong bối cảnh đó, bao cấp là một lựa chọn mang tính tình thế nhằm giữ ổn định tối thiểu và huy động nguồn lực. 
Nhưng khi chuyển sang thời bình, những hạn chế nội tại của cơ chế bộc lộ ngày càng rõ.`,
      },
    ],
    images: [
  ...
  en: {
    ...
    subtitle: "Historical background and reasons for the subsidy system's existence",
    sections: [
      {
...
The National Museum of History describes in detail the mechanism and scope of application, highlighting the compulsory nature of material distribution under scarcity.`,
      ...
      },
      {
        ...
        text: `In that context, the subsidy mechanism was a situational choice to maintain minimal stability and mobilize resources. 
However, when transitioning to peacetime, the internal limitations of the system became increasingly apparent.`,
      },
    ],
    images: [
